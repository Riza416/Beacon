    ...
    Tables: {
      ...
      request_dependencies: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "request_dependencies_depends_on_id_fkey";
      ...
      request_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "request_events_to_status_id_fkey";
          ...
          {
            foreignKeyName: "request_events_from_status_id_fkey";
